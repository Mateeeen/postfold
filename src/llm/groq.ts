  ...
  async draftPost(input: {
    ...
    const result = await this.complete<{ text?: string; rationale?: string }>(
      ...
      [
        ...
        'someone could disagree with, a number that sounds wrong until explained, a',
        'specific moment. What does not: a rhetorical question, "Here is the thing",',
        '"Let that sink in", announcing what the post is about before saying it, or',
        'any opening that would fit on a different post about a different subject.',
        '',
        'Land a complete thought inside the opening. Someone who reads only that',
        'much should still have got something.',
        '',
        'Say one concrete thing and stop. No hashtag pile, no engagement bait, no',
        'asking people to comment, no listing five lessons.',
        '',
